...
var introAveMariaUm = new Partes('','O anjo do senhor anunciou à Maria. E ela concebeu do Espírito Santo')
var introAveMariaDois = new Partes('', 'Eis aqui a escrava do Senhor. Faça-se em mim segundo a vossa palavra')
var introAveMariaTres = new Partes('', 'E o Verbo se fez carne. E habitou entre nós')
...
var introSalveRainha = new Partes('','Infinitas graças vos damos, Soberana Rainha, pelos benefícios que todos os dias recebemos de vossas mãos liberais. Dignai-vos agora e para sempre, tomar-nos debaixo de vosso misericordioso amparo, e para mais vos obrigar, vos saudamos com a Salve Rainha.')
